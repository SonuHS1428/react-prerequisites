...
/* here create order API won't take a callback function but it will only take card details and returns as a promise
whenever this line is executed create order API returns as a promise,a promise is nothing but you can assume it to be a empty object
and we know that create order API is an asynchronous operation and we don't know how much time it takes to execute
suppose after 5 or 10 seconds create order API will create an order and it will gives us order details and that will fill this undefined place
...
/* Promise.race():
   ...
   suppose p1,p2,p3 takes 3s,5s,2s to settled and assume p2 will get rejected..the output will be first it prints err2 then val3 then val1*/
...
in Promise.race() irrespective of success or failure it will return the result. over here you will wait for first success
